...
class _NSuspensionState extends State<NSuspension> {
  late ValueNotifier _topVN ;
  late ValueNotifier _leftVN ;

  @override
  Widget build(BuildContext context) {
    return LayoutBuilder(
        builder: (context, constraints){
          _topVN =ValueNotifier(constraints.maxHeight-widget.childSize.height-20);
          _leftVN = ValueNotifier(constraints.maxWidth - widget.childSize.width-20);
          return Stack(
