...
class Countdown extends StatefulWidget {
  ...
  final Widget Function(BuildContext) buildPause;
...
class _CountdownState extends State<Countdown> {
  ...
  Widget build(BuildContext context) {
    return !_onPausedExecuted ?widget.build(
      context,
